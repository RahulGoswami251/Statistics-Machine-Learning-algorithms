...
#### Extract Nokia lumia phone reviews from Amazon ecommerce website and do sentiment analysis on it by emotion mining ####
...
txt = readLines("C:\\Users\\Rahul\\Desktop\\amazon nokia lumia reviews.txt")
