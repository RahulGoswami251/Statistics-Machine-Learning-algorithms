...
#Load Aviation data 
aviation<-read.csv("E:\\2nd May Data Science Class\\Excel R Data Science Course_Class work_2nd_may_2020\\All Models In R code\\Forcasting Analysis\\Aviation.csv") 
View(aviation)
