...
##### Classification model of spam SMS messages using Naive Bayes ######

## Example: Filtering spam SMS messages ----
## Step 2: Exploring and preparing the data ---- 
# Read the sms data into the sms data frame
sms_spam <- read.csv('E:\\2nd May Data Science Class\\Excel R Data Science Course_Class work_2nd_may_2020\\All Models In R code\\Naive_Bayes\\sms_spam.csv', stringsAsFactors = FALSE)
